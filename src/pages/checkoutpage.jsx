  ...
  return (
    <>
      ...
      <div className='auth-form-container11'>
        ...
        {/* Display the response data in a table if available */}
        {/* {responseData && (
        ...
        {/* {storedCartResponse && (
          <div>
            <h2>Stored Cart Response</h2>
            <pre>{JSON.stringify(storedCartResponse, null, 2)}</pre>
          </div>
        )}

        {totalPriceResponse && (
          <div>
            <h2>Total Price Response</h2>
            <pre>{JSON.stringify(totalPriceResponse, null, 2)}</pre>
          </div>
        )} */}
